...
:: Android packaging
set AND_CERT_NAME="ChaoticFrenzy"
set AND_CERT_PASS=2bon2b
set AND_CERT_FILE=cert\ChaoticFrenzy.p12
...
set IOS_PROVISION=cert\ChaoticFrenzy.mobileprovision
